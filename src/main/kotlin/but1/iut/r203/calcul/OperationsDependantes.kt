 ...
 * @author mottu-jm
 */
class OperationsDependantes(val randomIntProvider: IntProvider) {
    ...
    fun diviserNaturelConsole(): Float {
        var dividende = randomIntProvider.provideInt()
        var diviseur = randomIntProvider.provideInt()
        if (diviseur == 0) {
    ...
    fun factorielleConsole(): Int {
        var paramConsole = randomIntProvider.provideInt()
        var retourFact = 1
